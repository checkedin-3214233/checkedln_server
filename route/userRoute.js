...
import { getUser, updateUser, getSearchedUser, getUserById, getSuggestedUsers, getMyBuddies, getBuddiesByUserId, getCheckInByUserId } from '../controller/userController.js';
...
router.get("/getCheckInByUserId/:userId", getCheckInByUserId);
